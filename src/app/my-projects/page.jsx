...
const projectsData = [
  {
    ...
    usedTechnology: ["Framer Motion", "Next JS", "Tailwind Css"],
    image: "/spacex.png",
...
const Page = () => {
  ...
  return (
    <div className="bg-white p-5 mt-5 mb-12 rounded-lg mx-4 md:mx-0">
        ...
        {projectsData.map((v, i) => {
          return (
            <motion.div key={i}
              ...
              <div className="border border-dotted hover:border-gray-300 hover:bg-gray-50 cursor-pointer rounded-lg p-4 bg-[url('/images/bg.png')] bg-center bg-cover bg-no-repeat">
                ...
                <div>
                  <img
                    src={v.image}
                    alt="Project Image"
                    className="projectImage w-28 object-left h-16 object-contain my-4"
                  />
                  <h1 className="text-2xl text-gray-800 font-semibold mb-3">
                    {v.title}
                  </h1>
                  <p className="text-sm line-clamp-2 text-gray-700/80">
                    {v.desc}
                  </p>
              ...
              <img
                alt="image here"
                className="absolute -right-14 -bottom-16 w-44 opacity-5 group-hover:scale-110 transition-all"
